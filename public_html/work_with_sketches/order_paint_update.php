...
#========================================================
# Страница с рисовкой (изменением) эскиза к странице заказа
#========================================================
...
<head>
    ...
    <script src="../assets/script/paint_update_2.js" defer></script>
...
<div class="common_div_body">
    ...
    <h2 class="update_title">Изменение страницы № <?= $page ?></h2>
    ...
    <div class="place_find">
        ...
        <button class="common_button" id="save_img">Изменить</button>
    </div>
